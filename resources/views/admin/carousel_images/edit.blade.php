                ...
                <form action="{{ route('admin.carousel-images.update', $carouselImage->id) }}" method="POST"
                    ...
                    <div class="file-field input-field">
                        ...
                        <div class="file-path-wrapper">
                            <input class="file-path validate" type="text"
                                placeholder="Upload new carousel image (optional)">
                        </div>
                        @error('image_path')
                    ...
                    <div class="input-field">
                        <input type="text" name="caption" id="caption"
                            value="{{ old('caption', $carouselImage->caption) }}">
                    ...
                    <div class="input-field">
                        <input type="number" name="order" id="order" value="{{ old('order', $carouselImage->order) }}"
                            min="1" required>
