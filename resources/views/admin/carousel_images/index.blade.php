    ...
    <div class="row" style="margin-bottom:0;">
        ...
        <div class="col s12 m9 l10 offset-m3 offset-l2" style="margin-left:220px;">
            <div class="section">
                ...
                <a href="{{ route('admin.carousel-images.create') }}" class="btn red white-text"
                    style="margin-bottom: 20px;">Add New Image</a>
                    ...
                    <tbody>
                        @forelse($carouselImages as $image)
                            <tr>
                                ...
                                <td>{{ $image->order }}</td>
                                <td>
                                    <a href="{{ route('admin.carousel-images.edit', $image->id) }}"
