            ...
            <tbody>
                @foreach($news as $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('news.show', $item->slug) }}" class="btn-small waves-effect waves-light"
                                style="background:#C41E3A;" target="_blank" title="View"><i
                                    class="material-icons white-text">visibility</i></a>
                            <a href="{{ route('admin.news.edit', $item->slug) }}" class="btn-small waves-effect waves-light"
                                style="background:#444;" title="Edit"><i class="material-icons white-text">edit</i></a>
                            <form method="POST" action="{{ route('admin.news.destroy', $item->slug) }}"
                                style="display: inline;">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn-small waves-effect waves-light" style="background:#888;"
                                    onclick="return confirm('Are you sure you want to delete this post?')" title="Delete"><i
                                        class="material-icons white-text">delete</i></button>
                            </form>
                        </td>
                    </tr>
                @endforeach
                @foreach($announcements as $item)
                    <tr>
                        ...
                        <td>{{ $item->created_at->format('M d, Y') }}</td>
                        <td>
                            <a href="{{ route('announcements.show', $item->slug) }}" class="btn-small waves-effect waves-light"
                                style="background:#C41E3A;" target="_blank" title="View"><i
                                    class="material-icons white-text">visibility</i></a>
                ...
                @foreach($jobs as $item)
                    <tr>
                        ...
                        <td>{{ $item->created_at->format('M d, Y') }}</td>
                        <td>
                            <a href="{{ route('jobs.show', $item->slug) }}" class="btn-small waves-effect waves-light"
                                style="background:#C41E3A;" target="_blank" title="View"><i
                                    class="material-icons white-text">visibility</i></a>
                            <a href="{{ route('admin.jobs.edit', $item->slug) }}" class="btn-small waves-effect waves-light"
                                style="background:#444;" title="Edit"><i class="material-icons white-text">edit</i></a>
                ...
                @foreach($events as $item)
                    <tr>
                        ...
                        <td>{{ $item->created_at->format('M d, Y') }}</td>
                        <td>
                            <a href="{{ route('events.show', $item->slug) }}" class="btn-small waves-effect waves-light"
                                style="background:#C41E3A;" target="_blank" title="View"><i
                                    class="material-icons white-text">visibility</i></a>
                            <a href="{{ route('admin.events.edit', $item->slug) }}" class="btn-small waves-effect waves-light"
                                style="background:#444;" title="Edit"><i class="material-icons white-text">edit</i></a>
