    ...
    <div class="container">
        ...
        <form action="{{ route('admin.officials.update', $official->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="input-field">
                ...
                <textarea name="bio" id="bio" class="materialize-textarea">{{ old('bio', $official->bio) }}</textarea>
            </div>
            <div class="file-field input-field">
                ...
                @if($official->photo)
                    <div style="margin-top:10px;">
                        <img src="{{ asset('storage/' . $official->photo) }}" alt="Current Photo" style="max-width:100px;">
                    </div>
                @endif
            </div>
            <div class="input-field">
