...
@section('content')
    <div class="section" style="max-width: 900px; margin: 0 auto;">
        <h2 style="color:#C41E3A;font-weight:800;text-align:center;margin-bottom:2rem;letter-spacing:1px;">University
            Announcements</h2>
        ...
        <div class="card" style="box-shadow: 0 4px 24px rgba(196,30,58,0.08); border-radius: 16px;">
            ...
            <div class="card-content" style="padding:2.5rem 2rem 2rem 2rem;">
                ...
                <div class="announcement-content wysiwyg-content" style="font-size:1.15rem;line-height:1.7;color:#222;">
    ...
    <div class="section" style="max-width: 900px; margin: 2rem auto 0 auto;">
        ...
        <div class="row">
            @php
                $popular = \App\Models\Announcement::orderBy('created_at', 'desc')->limit(3)->get();
            @endphp
                    ...
                    <div class="card hoverable" style="border-radius:10px;">
                        @if($item->picture)
                            <div class="card-image" style="border-radius:10px 10px 0 0;overflow:hidden;">
                                <img src="{{ asset('storage/' . $item->picture) }}" alt="Popular Announcement Image"
                        ...
                        <div class="card-action" style="padding:0 1rem 1rem 1rem;">
                            <a href="{{ route('announcements.show', $item->slug) }}" class="red-text">Read More</a>
                        </div>
                    </div>
                </div>
            @endforeach
